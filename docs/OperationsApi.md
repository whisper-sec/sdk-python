...
# **ai_attribute**
> JobResponse ai_attribute(attribute_request)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OperationsApi->ai_attribute:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->ai_attribute: %s\n" % e)
```
...
# **ai_correlate**
> JobResponse ai_correlate(correlate_request)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OperationsApi->ai_correlate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->ai_correlate: %s\n" % e)
```
...
# **ai_investigate**
> JobResponse ai_investigate(investigate_request)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisper_api_sdk.OperationsApi(api_client)
    investigate_request = whisper_api_sdk.InvestigateRequest() # InvestigateRequest | Investigation request

    try:
        # AI Threat Investigation (Asynchronous)
        api_response = api_instance.ai_investigate(investigate_request)
        print("The response of OperationsApi->ai_investigate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->ai_investigate: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **investigate_request** | [**InvestigateRequest**](InvestigateRequest.md)| Investigation request | 
...
# **ai_pivot**
> JobResponse ai_pivot(pivot_request)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OperationsApi->ai_pivot:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->ai_pivot: %s\n" % e)
```
...
# **find_similar_cases**
> JobResponse find_similar_cases(similar_cases_request)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OperationsApi->find_similar_cases:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->find_similar_cases: %s\n" % e)
```
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    size = 'enterprise' # str | Organization size filter (optional)
    region = 'north_america' # str | Geographic region filter (optional)

    try:
        # Get Industry Security Benchmark (Synchronous)
        api_response = api_instance.get_industry_benchmark(industry, size=size, region=region)
        print("The response of OperationsApi->get_industry_benchmark:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsApi->get_industry_benchmark: %s\n" % e)
```
 ...
 **size** | **str**| Organization size filter | [optional] 
 **region** | **str**| Geographic region filter | [optional] 

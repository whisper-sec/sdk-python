...
------------ | ------------- | ------------- | -------------
**incoming_links** | [**LinksInfo**](LinksInfo.md) | Incoming links from other domains | [optional] 
**outgoing_links** | [**LinksInfo**](LinksInfo.md) | Outgoing links to other domains | [optional] 

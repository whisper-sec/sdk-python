...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    bulk_ip_location_request = whisper_api_sdk.BulkIpLocationRequest() # BulkIpLocationRequest | List of IP addresses to lookup. Maximum 1000 IPs per request.

    try:
        # Bulk IP Geolocation Lookup
        api_instance.get_bulk_ip_location(bulk_ip_location_request)
...
------------- | ------------- | ------------- | -------------
 **bulk_ip_location_request** | [**BulkIpLocationRequest**](BulkIpLocationRequest.md)| List of IP addresses to lookup. Maximum 1000 IPs per request. | 
...
# **get_ip_location**
> IpGeolocationResponse get_ip_location(ip)
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisper_api_sdk.LocationApi(api_client)
    ip = '8.8.8.8' # str | The IPv4 address to lookup. IPv6 is not currently supported.

    try:
        # Get IP Geolocation and ASN Data
        api_response = api_instance.get_ip_location(ip)
        print("The response of LocationApi->get_ip_location:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ip** | **str**| The IPv4 address to lookup. IPv6 is not currently supported. | 
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisper_api_sdk.LocationApi(api_client)
    cidr = '8.8.8.0/24' # str | The network range in CIDR notation (e.g., 8.8.8.0/24 or 2001:db8::/32).

    try:
        # Get Network/CIDR Geolocation Data
        api_instance.get_network_location(cidr)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cidr** | **str**| The network range in CIDR notation (e.g., 8.8.8.0/24 or 2001:db8::/32). | 
...
with whisper_api_sdk.ApiClient(configuration) as api_client:
    ...
    limit = '100' # str | Maximum number of results to return (1-1000). Default: 100. Note: Pagination is not currently supported - use smaller limits for faster responses. (optional)
 ...
 **limit** | **str**| Maximum number of results to return (1-1000). Default: 100. Note: Pagination is not currently supported - use smaller limits for faster responses. | [optional] 

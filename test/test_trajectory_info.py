...
class TestTrajectoryInfo(unittest.TestCase):
    """TrajectoryInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrajectoryInfo:
        """Test TrajectoryInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrajectoryInfo`
        """

...
class TestIpIntelligenceResponseGeolocation(unittest.TestCase):
    """IpIntelligenceResponseGeolocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IpIntelligenceResponseGeolocation:
        """Test IpIntelligenceResponseGeolocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpIntelligenceResponseGeolocation`
        """
        model = IpIntelligenceResponseGeolocation()
        if include_optional:
            return IpIntelligenceResponseGeolocation(
    ...
    def testIpIntelligenceResponseGeolocation(self):
        """Test IpIntelligenceResponseGeolocation"""

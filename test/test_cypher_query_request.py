...
class TestCypherQueryRequest(unittest.TestCase):
    """CypherQueryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CypherQueryRequest:
        """Test CypherQueryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CypherQueryRequest`
        """
        model = CypherQueryRequest()
        if include_optional:
            return CypherQueryRequest(
                query = 'MATCH (d:DomainName {name: $domain})-[:hasIP]->(ip:A_ADDRESS) RETURN ip.name AS ip',
    ...
    def testCypherQueryRequest(self):
        """Test CypherQueryRequest"""

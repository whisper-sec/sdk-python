...
class TestServiceDiscoveryConfig(unittest.TestCase):
    """ServiceDiscoveryConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDiscoveryConfig:
        """Test ServiceDiscoveryConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDiscoveryConfig`
        """
    ...
    def testServiceDiscoveryConfig(self):
        """Test ServiceDiscoveryConfig"""

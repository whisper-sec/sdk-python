...
class TestMonitoringStatusResponse(unittest.TestCase):
    """MonitoringStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringStatusResponse:
        """Test MonitoringStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringStatusResponse`
        """
        model = MonitoringStatusResponse()
        if include_optional:
            return MonitoringStatusResponse(
                target = 'example.com',
                status = 'active',
                metrics = whisper_api_sdk.models.monitoring_metrics.MonitoringMetrics(
                    uptime_percentage = 99.95, 
                    avg_response_time = 245, 
                    ssl_expires_in_days = 45, 
                    dns_change_count = 2, 
                    whois_change_count = 0, 
    ...
    def testMonitoringStatusResponse(self):
        """Test MonitoringStatusResponse"""

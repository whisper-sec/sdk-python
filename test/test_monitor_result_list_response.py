...
class TestMonitorResultListResponse(unittest.TestCase):
    """MonitorResultListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorResultListResponse:
        """Test MonitorResultListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorResultListResponse`
        """
        model = MonitorResultListResponse()
        if include_optional:
            return MonitorResultListResponse(
                check_id = 'abc123',
                count = 10,
                results = [
                    whisper_api_sdk.models.monitor_result_response.MonitorResultResponse(
    ...
    def testMonitorResultListResponse(self):
        """Test MonitorResultListResponse"""

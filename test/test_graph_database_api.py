...
from whisper_api_sdk.api.graph_database_api import GraphDatabaseApi


class TestGraphDatabaseApi(unittest.TestCase):
    """GraphDatabaseApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GraphDatabaseApi()

    def tearDown(self) -> None:
        pass

    def test_execute_cypher_query(self) -> None:
        """Test case for execute_cypher_query

        Execute Cypher Query
        """
        pass

    def test_execute_graph_ql(self) -> None:
        """Test case for execute_graph_ql

        Execute GraphQL Query
        """
        pass

    def test_get_graphi_ql(self) -> None:
        """Test case for get_graphi_ql

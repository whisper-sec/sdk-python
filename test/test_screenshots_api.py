...
from whisper_api_sdk.api.screenshots_api import ScreenshotsApi
...
class TestScreenshotsApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = ScreenshotsApi()

    def tearDown(self) -> None:
        pass

    def test_clear_screenshot_history(self) -> None:
        """Test case for clear_screenshot_history
    ...
    def test_delete_screenshot_schedule(self) -> None:
        """Test case for delete_screenshot_schedule
    ...
    def test_get_screenshot_schedule(self) -> None:
        """Test case for get_screenshot_schedule

        Get Screenshot Schedule Details
        """
        pass

    def test_list_screenshot_schedules(self) -> None:
        """Test case for list_screenshot_schedules

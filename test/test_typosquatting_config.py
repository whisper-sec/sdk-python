...
class TestTyposquattingConfig(unittest.TestCase):
    """TyposquattingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TyposquattingConfig:
        """Test TyposquattingConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TyposquattingConfig`
        """
        model = TyposquattingConfig()
        if include_optional:
            return TyposquattingConfig(
    ...
    def testTyposquattingConfig(self):
        """Test TyposquattingConfig"""

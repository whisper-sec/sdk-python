...
class TestAttributeResult(unittest.TestCase):
    """AttributeResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeResult:
        """Test AttributeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeResult`
        """
        model = AttributeResult()
        if include_optional:

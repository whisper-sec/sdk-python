...
class TestInvestigateContext(unittest.TestCase):
    """InvestigateContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigateContext:
        """Test InvestigateContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigateContext`
        """
        model = InvestigateContext()
        if include_optional:
            return InvestigateContext(
                hypothesis = 'Suspected phishing campaign targeting financial sector',
                related_indicators = [1.2.3.4, malware.com, abc123def456],
                time_range = '30d',
                industry = 'financial',
                region = 'us-east'
            )
    ...
    def testInvestigateContext(self):
        """Test InvestigateContext"""

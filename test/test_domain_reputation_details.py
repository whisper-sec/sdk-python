...
class TestDomainReputationDetails(unittest.TestCase):
    """DomainReputationDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainReputationDetails:
        """Test DomainReputationDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainReputationDetails`
        """
        model = DomainReputationDetails()
        if include_optional:
            return DomainReputationDetails(
                domain_ips = ["8.8.8.8"],
                domain_ip_scores = {
                    'key' : 1.337
                    },
    ...
    def testDomainReputationDetails(self):
        """Test DomainReputationDetails"""

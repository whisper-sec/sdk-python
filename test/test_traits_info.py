...
class TestTraitsInfo(unittest.TestCase):
    """TraitsInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TraitsInfo:
        """Test TraitsInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TraitsInfo`
        """
        model = TraitsInfo()
        if include_optional:
            return TraitsInfo(

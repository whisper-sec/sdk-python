...
class TestBulkEnrichmentResult(unittest.TestCase):
    """BulkEnrichmentResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEnrichmentResult:
        """Test BulkEnrichmentResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEnrichmentResult`
        """
        model = BulkEnrichmentResult()
        if include_optional:
    ...
    def testBulkEnrichmentResult(self):
        """Test BulkEnrichmentResult"""

...
from whisper_api_sdk.api.infrastructure_scanning_api import InfrastructureScanningApi


class TestInfrastructureScanningApi(unittest.TestCase):
    """InfrastructureScanningApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InfrastructureScanningApi()

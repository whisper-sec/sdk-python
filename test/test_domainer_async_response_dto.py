...
class TestDomainerAsyncResponseDTO(unittest.TestCase):
    """DomainerAsyncResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainerAsyncResponseDTO:
        """Test DomainerAsyncResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainerAsyncResponseDTO`
        """
        model = DomainerAsyncResponseDTO()
        if include_optional:
            return DomainerAsyncResponseDTO(
                request_id = '123e4567-e89b-12d3-a456-426614174000',
                domain_name = 'example.com',
                query_string = 'exampl*',
                message = 'Request received and processing has started',
                status_url = '/api/domains/async/123e4567-e89b-12d3-a456-426614174000'
            )
        else:
            return DomainerAsyncResponseDTO(
                request_id = '123e4567-e89b-12d3-a456-426614174000',
    ...
    def testDomainerAsyncResponseDTO(self):
        """Test DomainerAsyncResponseDTO"""

...
class TestCityInfo(unittest.TestCase):
    """CityInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CityInfo:
        """Test CityInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CityInfo`
        """
        model = CityInfo()
        if include_optional:
            return CityInfo(

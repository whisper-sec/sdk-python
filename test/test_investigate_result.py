...
class TestInvestigateResult(unittest.TestCase):
    """InvestigateResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigateResult:
        """Test InvestigateResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigateResult`
        """
        model = InvestigateResult()
        if include_optional:
    ...
    def testInvestigateResult(self):
        """Test InvestigateResult"""

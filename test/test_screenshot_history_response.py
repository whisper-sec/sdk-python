...
class TestScreenshotHistoryResponse(unittest.TestCase):
    """ScreenshotHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreenshotHistoryResponse:
        """Test ScreenshotHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreenshotHistoryResponse`
        """
        model = ScreenshotHistoryResponse()
        if include_optional:
            return ScreenshotHistoryResponse(
                target = 'example.com',
                schedules = [
                    whisper_api_sdk.models.schedule_with_screenshots.ScheduleWithScreenshots(
                        schedule_id = 'sched_abc123', 
                        url = 'https://example.com', 
                        screenshots = [
                            whisper_api_sdk.models.screenshot_entry.ScreenshotEntry(
    ...
    def testScreenshotHistoryResponse(self):
        """Test ScreenshotHistoryResponse"""

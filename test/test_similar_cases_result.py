...
class TestSimilarCasesResult(unittest.TestCase):
    """SimilarCasesResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarCasesResult:
        """Test SimilarCasesResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarCasesResult`
        """
    ...
    def testSimilarCasesResult(self):
        """Test SimilarCasesResult"""

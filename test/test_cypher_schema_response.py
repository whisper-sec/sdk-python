...
class TestCypherSchemaResponse(unittest.TestCase):
    """CypherSchemaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CypherSchemaResponse:
        """Test CypherSchemaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CypherSchemaResponse`
        """
        model = CypherSchemaResponse()
        if include_optional:
            return CypherSchemaResponse(
                node_labels = [DomainName, A_ADDRESS, AAAA_ADDRESS, ASN, TLD],
                relationship_types = [hasIP, hasIPv6, hasNameserver, hasMailHost, announces, isListed],
                node_properties = {DomainName=[name, created], A_ADDRESS=[name, firstSeen, lastSeen]},
                relationship_properties = {hasIP=[firstSeen, lastSeen], isListed=[addedDate]},
                node_count = 15000000,
                relationship_count = 50000000
            )
        else:
            return CypherSchemaResponse(
        )
    ...
    def testCypherSchemaResponse(self):
        """Test CypherSchemaResponse"""

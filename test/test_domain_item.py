...
class TestDomainItem(unittest.TestCase):
    """DomainItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainItem:
        """Test DomainItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainItem`
        """
        model = DomainItem()
        if include_optional:
            return DomainItem(

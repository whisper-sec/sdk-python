...
class TestScheduleWithScreenshots(unittest.TestCase):
    """ScheduleWithScreenshots unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleWithScreenshots:
        """Test ScheduleWithScreenshots
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleWithScreenshots`
        """
        model = ScheduleWithScreenshots()
        if include_optional:
            return ScheduleWithScreenshots(
    ...
    def testScheduleWithScreenshots(self):
        """Test ScheduleWithScreenshots"""

...
class TestIndustryInfo(unittest.TestCase):
    """IndustryInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndustryInfo:
        """Test IndustryInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndustryInfo`
        """
        model = IndustryInfo()
        if include_optional:
            return IndustryInfo(

...
class TestScreenshotScheduleListResponse(unittest.TestCase):
    """ScreenshotScheduleListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreenshotScheduleListResponse:
        """Test ScreenshotScheduleListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreenshotScheduleListResponse`
        """
        model = ScreenshotScheduleListResponse()
        if include_optional:
            return ScreenshotScheduleListResponse(
                ...
                schedules = [
                    whisper_api_sdk.models.screenshot_schedule.ScreenshotSchedule(
                        id = 'sched_abc123', 
                        ...
                        timezone = 'UTC', 
                        enabled = True, 
                        options = {width=1920, height=1080, full_page=false, wait_time=2000, format=png, quality=90, javascript=true, block_ads=false}, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_capture_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        next_capture_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        capture_count = 56, )
                    ]
            )
        else:
    ...
    def testScreenshotScheduleListResponse(self):
        """Test ScreenshotScheduleListResponse"""

...
class TestDomainIntelligenceResponse(unittest.TestCase):
    """DomainIntelligenceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainIntelligenceResponse:
        """Test DomainIntelligenceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainIntelligenceResponse`
        """
        model = DomainIntelligenceResponse()
        if include_optional:
            return DomainIntelligenceResponse(
                query = noctis_frontgraph_sdk.models.domain_intelligence_response_query.DomainIntelligenceResponse_query(
                    domain = 'example.com', 
                    timestamp = '2025-09-13T10:30Z', 
                    response_time_ms = 5500, ),
                summary = noctis_frontgraph_sdk.models.domain_intelligence_response_summary.DomainIntelligenceResponse_summary(
    ...
    def testDomainIntelligenceResponse(self):
        """Test DomainIntelligenceResponse"""

...
class TestTrackedIndicatorsResponse(unittest.TestCase):
    """TrackedIndicatorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackedIndicatorsResponse:
        """Test TrackedIndicatorsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackedIndicatorsResponse`
        """
        model = TrackedIndicatorsResponse()
        if include_optional:
            return TrackedIndicatorsResponse(
                count = 5,
                max_tracked = 50,
                indicators = [
                    whisper_api_sdk.models.tracked_indicator.TrackedIndicator(
                        type = 'domain', 
                        value = 'example.com', 
                        enabled = True, 
                        frequency = 'daily', 
    ...
    def testTrackedIndicatorsResponse(self):
        """Test TrackedIndicatorsResponse"""

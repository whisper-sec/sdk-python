...
class TestMonitorResultResponse(unittest.TestCase):
    """MonitorResultResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorResultResponse:
        """Test MonitorResultResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorResultResponse`
        """
        model = MonitorResultResponse()
        if include_optional:
    ...
    def testMonitorResultResponse(self):
        """Test MonitorResultResponse"""

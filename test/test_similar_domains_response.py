...
class TestSimilarDomainsResponse(unittest.TestCase):
    """SimilarDomainsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarDomainsResponse:
        """Test SimilarDomainsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarDomainsResponse`
        """
        model = SimilarDomainsResponse()
        if include_optional:
            return SimilarDomainsResponse(
                domain = 'google.com',
                status = 'completed',
                similar_domains = [
                    whisper_api_sdk.models.similar_domain_entry.SimilarDomainEntry(
                        domain = 'gooogle.com', 
                        technique = 'TYPO', )
                    ],
                total_count = 150,
                analysis = whisper_api_sdk.models.analysis_metadata.AnalysisMetadata(
                    techniques_used = 'TYPO,UTFVARS', 
                    base_domain = 'google.com', 
                    search_limit = 100, ),
                error = True,
                message = 'Failed to generate similar domains: Connection timeout'
            )
        else:
            return SimilarDomainsResponse(
                domain = 'google.com',
    ...
    def testSimilarDomainsResponse(self):
        """Test SimilarDomainsResponse"""

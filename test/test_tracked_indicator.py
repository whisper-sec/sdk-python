...
class TestTrackedIndicator(unittest.TestCase):
    """TrackedIndicator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackedIndicator:
        """Test TrackedIndicator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackedIndicator`
        """
        model = TrackedIndicator()
        if include_optional:
            return TrackedIndicator(
                type = 'domain',
                value = 'example.com',
                enabled = True,
                frequency = 'daily',

...
class TestAttributionContext(unittest.TestCase):
    """AttributionContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributionContext:
        """Test AttributionContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributionContext`
        """
        model = AttributionContext()
        if include_optional:
            return AttributionContext(
                observed_ttps = [T1071, T1059.001, T1566.002],
                targeted_sector = 'financial',
                target_region = 'US',
    ...
    def testAttributionContext(self):
        """Test AttributionContext"""

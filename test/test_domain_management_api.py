...
class TestDomainManagementApi(unittest.TestCase):
    """DomainManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DomainManagementApi()

    def tearDown(self) -> None:
        pass

    def test_find_subdomains(self) -> None:
        """Test case for find_subdomains

...
from whisper_api_sdk.api.change_tracking_api import ChangeTrackingApi


class TestChangeTrackingApi(unittest.TestCase):
    """ChangeTrackingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ChangeTrackingApi()

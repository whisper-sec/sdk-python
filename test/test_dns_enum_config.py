...
class TestDnsEnumConfig(unittest.TestCase):
    """DnsEnumConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DnsEnumConfig:
        """Test DnsEnumConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DnsEnumConfig`
        """
        model = DnsEnumConfig()
        if include_optional:
            return DnsEnumConfig(
                subdomain_enum = True,
                zone_transfer = False,
                reverse_dns = True,

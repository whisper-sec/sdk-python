...
class TestIspInfo(unittest.TestCase):
    """IspInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IspInfo:
        """Test IspInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IspInfo`
        """
        model = IspInfo()
        if include_optional:
            return IspInfo(

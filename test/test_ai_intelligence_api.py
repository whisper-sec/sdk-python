...
from whisper_api_sdk.api.ai_intelligence_api import AIIntelligenceApi


class TestAIIntelligenceApi(unittest.TestCase):
    """AIIntelligenceApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AIIntelligenceApi()

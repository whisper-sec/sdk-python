...
class TestScreenshotScheduleConfig(unittest.TestCase):
    """ScreenshotScheduleConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreenshotScheduleConfig:
        """Test ScreenshotScheduleConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreenshotScheduleConfig`
        """
        model = ScreenshotScheduleConfig()
        if include_optional:
            return ScreenshotScheduleConfig(
                cron = '0',
                frequency = 'daily',
                timezone = 'UTC',
                retention_count = 30,
    ...
    def testScreenshotScheduleConfig(self):
        """Test ScreenshotScheduleConfig"""

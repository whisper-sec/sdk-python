...
class TestIpIntelligenceResponseGeolocationCoordinates(unittest.TestCase):
    """IpIntelligenceResponseGeolocationCoordinates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IpIntelligenceResponseGeolocationCoordinates:
        """Test IpIntelligenceResponseGeolocationCoordinates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpIntelligenceResponseGeolocationCoordinates`
        """
        model = IpIntelligenceResponseGeolocationCoordinates()
        if include_optional:
            return IpIntelligenceResponseGeolocationCoordinates(
                latitude = 37.4223,
                longitude = -122.085,
                accuracy_radius = 5,
    ...
    def testIpIntelligenceResponseGeolocationCoordinates(self):
        """Test IpIntelligenceResponseGeolocationCoordinates"""

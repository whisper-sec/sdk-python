...
class TestSimilarCasesRequest(unittest.TestCase):
    """SimilarCasesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarCasesRequest:
        """Test SimilarCasesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarCasesRequest`
        """
        model = SimilarCasesRequest()
        if include_optional:
            return SimilarCasesRequest(
                indicators = [8.8.8.8, evil-domain.com, 1.2.3.4],
                behavior_description = 'Suspicious outbound connections to known C2 infrastructure, data exfiltration attempts detected',
                observed_ttps = [T1071, T1566.001, T1059.001],
                min_similarity = 0.7,
                limit = 10
            )
        else:
    ...
    def testSimilarCasesRequest(self):
        """Test SimilarCasesRequest"""

    ...
    def make_instance(self, include_optional) -> JobListResponse:
        ...
        if include_optional:
            return JobListResponse(
                jobs = [
                    whisper_api_sdk.models.job_summary.JobSummary(
                        job_id = 'f6250320-9ed4-442b-a389-acfda52d9375', 
                        type = 'screenshot', 
                        status = 'COMPLETED', 
                        created_at = '2025-01-15T10:30:00Z', 
                        completed_at = '2025-01-15T10:30:05Z', 
                        progress = whisper_api_sdk.models.progress_info.ProgressInfo(
                            current = 5, 
                            total = 10, 
                            message = 'Processing indicators...', ), 
                        error = whisper_api_sdk.models.error_info.ErrorInfo(
                            code = 'TIMEOUT', 

...
class TestInfrastructureMapRequest(unittest.TestCase):
    """InfrastructureMapRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfrastructureMapRequest:
        """Test InfrastructureMapRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfrastructureMapRequest`
        """
        model = InfrastructureMapRequest()
        if include_optional:
            return InfrastructureMapRequest(
                start_point = 'example.com',
                depth = 2
            )
        else:
            return InfrastructureMapRequest(
    ...
    def testInfrastructureMapRequest(self):
        """Test InfrastructureMapRequest"""

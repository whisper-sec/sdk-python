...
class TestScreenshotEntry(unittest.TestCase):
    """ScreenshotEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreenshotEntry:
        """Test ScreenshotEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreenshotEntry`
        """
        model = ScreenshotEntry()
        if include_optional:

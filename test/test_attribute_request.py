    ...
    def make_instance(self, include_optional) -> AttributeRequest:
        ...
        if include_optional:
            return AttributeRequest(
                indicators = [8.8.8.8, evil.com, d41d8cd98f00b204e9800998ecf8427e],
                context = {observedTTPs=[T1071, T1059.001], targetedSector=financial, targetRegion=US, timeframe=2024-01-01 to 2024-12-31, malwareFamilies=[Emotet, TrickBot]}
            )
        else:
            return AttributeRequest(
                indicators = [8.8.8.8, evil.com, d41d8cd98f00b204e9800998ecf8427e],

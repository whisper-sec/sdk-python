...
class TestSimilarDomainEntry(unittest.TestCase):
    """SimilarDomainEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarDomainEntry:
        """Test SimilarDomainEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarDomainEntry`
        """
        model = SimilarDomainEntry()
        if include_optional:
            return SimilarDomainEntry(
                domain = 'gooogle.com',
                technique = 'TYPO'
            )
        else:
    ...
    def testSimilarDomainEntry(self):
        """Test SimilarDomainEntry"""

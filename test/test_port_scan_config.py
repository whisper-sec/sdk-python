...
class TestPortScanConfig(unittest.TestCase):
    """PortScanConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortScanConfig:
        """Test PortScanConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortScanConfig`
        """
        model = PortScanConfig()
        if include_optional:

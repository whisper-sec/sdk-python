...
class TestCoordinatesInfo(unittest.TestCase):
    """CoordinatesInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoordinatesInfo:
        """Test CoordinatesInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoordinatesInfo`
        """
        model = CoordinatesInfo()
        if include_optional:

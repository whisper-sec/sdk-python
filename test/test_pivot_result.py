...
class TestPivotResult(unittest.TestCase):
    """PivotResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PivotResult:
        """Test PivotResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PivotResult`
        """
        model = PivotResult()
        if include_optional:
            return PivotResult(

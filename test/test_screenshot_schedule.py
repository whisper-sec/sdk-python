...
class TestScreenshotSchedule(unittest.TestCase):
    """ScreenshotSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreenshotSchedule:
        """Test ScreenshotSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreenshotSchedule`
        """
        model = ScreenshotSchedule()
        if include_optional:
    ...
    def testScreenshotSchedule(self):
        """Test ScreenshotSchedule"""

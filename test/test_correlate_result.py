...
class TestCorrelateResult(unittest.TestCase):
    """CorrelateResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorrelateResult:
        """Test CorrelateResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorrelateResult`
        """
        model = CorrelateResult()
        if include_optional:

...
class TestCypherQueryResponse(unittest.TestCase):
    """CypherQueryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CypherQueryResponse:
        """Test CypherQueryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CypherQueryResponse`
        """
        model = CypherQueryResponse()
        if include_optional:
            return CypherQueryResponse(
                results = [{ip=8.8.8.8, country=US}, {ip=8.8.4.4, country=US}],
    ...
    def testCypherQueryResponse(self):
        """Test CypherQueryResponse"""

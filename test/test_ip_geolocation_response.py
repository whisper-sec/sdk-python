...
class TestIpGeolocationResponse(unittest.TestCase):
    """IpGeolocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IpGeolocationResponse:
        """Test IpGeolocationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpGeolocationResponse`
        """
        model = IpGeolocationResponse()
        if include_optional:
            return IpGeolocationResponse(
                ip = '8.8.8.8',
                country = whisper_api_sdk.models.country_info.CountryInfo(
                    iso_code = 'US', 
                    name = 'United States', 
                    confidence = 95, ),
                city = whisper_api_sdk.models.city_info.CityInfo(
                    name = 'mountain view', 
                    original_name = 'Mountain View', 
                    confidence = 80, ),
                location = whisper_api_sdk.models.location_info.LocationInfo(
                    latitude = 37.4223, 
                    longitude = -122.085, 
                    accuracy_radius = 20, 
                    time_zone = 'America/Los_Angeles', ),
                isp = whisper_api_sdk.models.isp_info.IspInfo(
                    name = 'Google LLC', 
                    organization = 'Level 3', 
                    asn = 15169, 
                    asn_organization = 'Google LLC', ),
                traits = whisper_api_sdk.models.traits_info.TraitsInfo(
                    user_type = 'hosting', 
                    is_anonymous_proxy = False, 
                    is_tor_exit_node = False, 
                    is_vpn = False, ),
                coordinates = whisper_api_sdk.models.coordinates_info.CoordinatesInfo(
                    latitude = 37.4223, 
                    longitude = -122.085, )
            )
        else:
    ...
    def testIpGeolocationResponse(self):
        """Test IpGeolocationResponse"""

...
class TestBulkIpLocationRequest(unittest.TestCase):
    """BulkIpLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkIpLocationRequest:
        """Test BulkIpLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkIpLocationRequest`
        """
        model = BulkIpLocationRequest()
        if include_optional:
            return BulkIpLocationRequest(
    ...
    def testBulkIpLocationRequest(self):
        """Test BulkIpLocationRequest"""

    ...
    def make_instance(self, include_optional) -> CorrelateRequest:
        ...
        if include_optional:
            return CorrelateRequest(
                indicators = [8.8.8.8, evil.com, 1.2.3.4],
                options = {"timeWindow":"30d","correlationTypes":["infrastructure","campaign","actor"],"minConfidence":0.7,"includeIndustryBreakdown":true,"includeCampaignDetection":true,"includeGeographicSpread":false,"includeAttackPatterns":true,"anonymizationLevel":"standard"}
            )
        else:
            return CorrelateRequest(
                indicators = [8.8.8.8, evil.com, 1.2.3.4],

...
from whisper_api_sdk.configuration import Configuration
from whisper_api_sdk.api_response import ApiResponse, T as ApiResponseT
import whisper_api_sdk.models
from whisper_api_sdk import rest
from whisper_api_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(whisper_api_sdk.models, klass)

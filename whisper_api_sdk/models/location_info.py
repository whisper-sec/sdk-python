...
class LocationInfo(BaseModel):
    ...
    accuracy_radius: Optional[StrictInt] = Field(default=None, description="Accuracy radius in kilometers - actual location is within this radius", alias="accuracyRadius")
    time_zone: Optional[StrictStr] = Field(default=None, description="IANA timezone identifier", alias="timeZone")
    __properties: ClassVar[List[str]] = ["latitude", "longitude", "accuracyRadius", "timeZone"]

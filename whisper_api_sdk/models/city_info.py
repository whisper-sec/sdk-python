...
class CityInfo(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Normalized city name (lowercase)")
    original_name: Optional[StrictStr] = Field(default=None, description="Original city name with proper capitalization", alias="originalName")
    confidence: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Confidence score for city detection (0-100)")
    __properties: ClassVar[List[str]] = ["name", "originalName", "confidence"]

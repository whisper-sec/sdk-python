...
class SimilarDomainsOpsRequest(BaseModel):
    ...
    """ # noqa: E501
    domain: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The target domain to generate variations for")
    techniques: Optional[StrictStr] = Field(default=None, description="Techniques to use for generating similar domains. Supported values: typosquatting, homoglyph, bitsquatting, tld_variation, sounding, prefix, suffix, contains, levenshtein. If not specified, defaults to typosquatting.")
    limit: Optional[StrictInt] = Field(default=None, description="Maximum number of similar domains to return per technique")
    options: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["domain", "techniques", "limit", "options"]

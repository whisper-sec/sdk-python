...
class ReputationInfo(BaseModel):
    ...
    blacklists: Optional[BlacklistScores] = Field(default=None, description="Blacklist presence scores across various threat feeds")
    domain_reputation: Optional[DomainReputationScores] = Field(default=None, description="Domain reputation based on infrastructure IP scoring (domains only)")

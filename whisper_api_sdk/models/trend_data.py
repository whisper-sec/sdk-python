...
class TrendData(BaseModel):
    ...
    """ # noqa: E501
    direction: Optional[StrictStr] = Field(default=None, description="Trend direction")
    risk_trend30d: Optional[StrictStr] = Field(default=None, description="30-day risk trend", alias="riskTrend30d")
    change_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Risk score change percentage", alias="changePercent")
    __properties: ClassVar[List[str]] = ["direction", "riskTrend30d", "changePercent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "riskTrend30d": obj.get("riskTrend30d"),

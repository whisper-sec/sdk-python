...
class InvestigateResult(BaseModel):
    ...
    """ # noqa: E501
    indicator: Optional[StrictStr] = Field(default=None, description="The indicator that was investigated")
    indicator_type: Optional[StrictStr] = Field(default=None, description="Type of the indicator", alias="indicatorType")
    status: Optional[StrictStr] = Field(default=None, description="Status of the investigation")
    error: Optional[StrictBool] = Field(default=None, description="Whether an error occurred during investigation")
    message: Optional[StrictStr] = Field(default=None, description="Error message if the investigation failed")
    investigation: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["indicator", "indicatorType", "status", "error", "message", "investigation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if investigation (nullable) is None
        # and model_fields_set contains the field
        if self.investigation is None and "investigation" in self.model_fields_set:
            _dict['investigation'] = None

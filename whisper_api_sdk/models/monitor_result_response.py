...
class MonitorResultResponse(BaseModel):
    ...
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="When the check was executed")
    success: Optional[StrictBool] = Field(default=None, description="Whether the check passed")
    location: Optional[StrictStr] = Field(default=None, description="Location where check ran")
    attempt: Optional[StrictInt] = Field(default=None, description="Check attempt number (for retries)")
    check_id: Optional[StrictStr] = Field(default=None, description="ID of the check this result belongs to", alias="checkId")
    result_id: Optional[StrictStr] = Field(default=None, description="Unique result ID", alias="resultId")
    response_time: Optional[StrictInt] = Field(default=None, description="Response time in milliseconds", alias="responseTime")
    status_code: Optional[StrictInt] = Field(default=None, description="HTTP status code received", alias="statusCode")
    error_message: Optional[StrictStr] = Field(default=None, description="Error message if check failed", alias="errorMessage")
    has_errors: Optional[StrictBool] = Field(default=None, description="Whether check ran from all locations", alias="hasErrors")
    __properties: ClassVar[List[str]] = ["timestamp", "success", "location", "attempt", "checkId", "resultId", "responseTime", "statusCode", "errorMessage", "hasErrors"]

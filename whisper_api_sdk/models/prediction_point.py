...
class PredictionPoint(BaseModel):
    ...
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Prediction confidence (0-1)")
    predicted_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Predicted risk score", alias="predictedScore")
    predicted_level: Optional[StrictStr] = Field(default=None, description="Predicted risk level", alias="predictedLevel")
    __properties: ClassVar[List[str]] = ["confidence", "predictedScore", "predictedLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predictedLevel": obj.get("predictedLevel")
        })
        return _obj

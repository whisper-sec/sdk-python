...
class AttributeResult(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the attribution analysis")
    error: Optional[StrictBool] = Field(default=None, description="Whether an error occurred")
    message: Optional[StrictStr] = Field(default=None, description="Error message if the attribution failed")
    attribution: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["indicators", "status", "error", "message", "attribution"]

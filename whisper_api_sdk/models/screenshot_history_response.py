...
class ScreenshotHistoryResponse(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="The target domain or URL queried")
    schedules: Optional[List[ScheduleWithScreenshots]] = Field(default=None, description="List of schedules that captured screenshots of this target")
    total_screenshots: Optional[StrictInt] = Field(default=None, description="Total number of screenshots available for this target")
    limit: Optional[StrictInt] = Field(default=None, description="Maximum number of screenshots returned (limit parameter)")
    __properties: ClassVar[List[str]] = ["target", "schedules", "total_screenshots", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedules": [ScheduleWithScreenshots.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None,
            "total_screenshots": obj.get("total_screenshots"),
            "limit": obj.get("limit")
        })
        return _obj

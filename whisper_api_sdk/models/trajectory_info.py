...
class TrajectoryInfo(BaseModel):
    ...
    """ # noqa: E501
    trend: Optional[StrictStr] = Field(default=None, description="Trend direction")
    velocity: Optional[StrictStr] = Field(default=None, description="Velocity of change")
    stability: Optional[StrictStr] = Field(default=None, description="Trend stability")
    __properties: ClassVar[List[str]] = ["trend", "velocity", "stability"]

...
class SimilarCase(BaseModel):
    ...
    """ # noqa: E501
    similarity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Similarity score (0-1)")
    outcome: Optional[StrictStr] = Field(default=None, description="Case outcome")
    case_id: Optional[StrictStr] = Field(default=None, description="Case ID", alias="caseId")
    __properties: ClassVar[List[str]] = ["similarity", "outcome", "caseId"]

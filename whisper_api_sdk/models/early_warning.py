...
class EarlyWarning(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Warning type")
    ...
    detected_at: Optional[StrictStr] = Field(default=None, description="Detection timestamp", alias="detectedAt")
    __properties: ClassVar[List[str]] = ["type", "severity", "message", "detectedAt"]

...
class IndustryInfo(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Industry code")
    description: Optional[StrictStr] = Field(default=None, description="Industry description")

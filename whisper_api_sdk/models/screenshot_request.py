...
class ScreenshotRequest(BaseModel):
    ...
    """ # noqa: E501
    url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The URL of the website to capture")
    options: Optional[ScreenshotOptions] = Field(default=None, description="Screenshot capture options")
    schedule: Optional[ScreenshotScheduleConfig] = Field(default=None, description="Scheduling configuration for recurring captures")
    __properties: ClassVar[List[str]] = ["url", "options", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": ScreenshotScheduleConfig.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj

...
class ScreenshotRequest(BaseModel):
    ...
    schedule: Optional[ScheduleConfig] = Field(default=None, description="Scheduling configuration for recurring captures")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": ScheduleConfig.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj

...
class ScanRequest(BaseModel):
    ...
    """ # noqa: E501
    domain: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The target domain to scan")
    type: Optional[Annotated[str, Field(strict=True)]] = Field(default='comprehensive', description="Type of scan to perform. Determines which scanning module to use.")
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(comprehensive|subdomains|ssl|dns|technologies|whois|vulnerability)$", value):
            raise ValueError(r"must validate the regular expression /^(comprehensive|subdomains|ssl|dns|technologies|whois|vulnerability)$/")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['comprehensive', 'subdomains', 'ssl', 'dns', 'technologies', 'whois', 'vulnerability']):
            raise ValueError("must be one of enum values ('comprehensive', 'subdomains', 'ssl', 'dns', 'technologies', 'whois', 'vulnerability')")
        return value

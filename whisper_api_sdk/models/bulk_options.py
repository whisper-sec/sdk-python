...
class BulkOptions(BaseModel):
    ...
    timeout_per_indicator: Optional[Annotated[int, Field(le=120000, strict=True, ge=1000)]] = Field(default=30000, description="Maximum time in milliseconds to wait for each indicator before timing out. Domain enrichment and ip_intelligence require longer timeouts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeout_per_indicator": obj.get("timeout_per_indicator") if obj.get("timeout_per_indicator") is not None else 30000,

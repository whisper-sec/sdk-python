...
class AttributeRequest(BaseModel):
    ...
    """ # noqa: E501
    indicators: Annotated[List[StrictStr], Field(min_length=0, max_length=500)] = Field(description="List of indicators (IPs, domains, hashes, URLs) for attribution analysis. Maximum 500 indicators per request.")
    context: Optional[AttributionContext] = Field(default=None, description="Optional context object to enhance attribution accuracy. NOT a string - must be an object with fields like observedTTPs, targetedSector, etc.")
    __properties: ClassVar[List[str]] = ["indicators", "context"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": AttributionContext.from_dict(obj["context"]) if obj.get("context") is not None else None
        })
        return _obj

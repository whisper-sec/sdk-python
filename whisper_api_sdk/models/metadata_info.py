...
class MetadataInfo(BaseModel):
    ...
    """ # noqa: E501
    data_sources: Optional[List[StrictStr]] = Field(default=None, description="List of data sources used to build this response")
    errors: Optional[List[StrictStr]] = Field(default=None, description="Any non-fatal errors encountered during data collection. Empty if all sources succeeded.")
    __properties: ClassVar[List[str]] = ["data_sources", "errors"]

...
class GraphLink(BaseModel):
    ...
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="ID of the source node (where the relationship originates)")
    target: Optional[StrictStr] = Field(default=None, description="ID of the target node (where the relationship points to)")
    type: Optional[StrictStr] = Field(default=None, description="Type of relationship between the nodes")
    weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Weight or strength of the relationship (for layout algorithms)")
    properties: Optional[Dict[str, Any]] = Field(default=None, description="Additional properties for link styling or filtering")
    __properties: ClassVar[List[str]] = ["source", "target", "type", "weight", "properties"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['resolvesTo', 'hasNameserver', 'hasMailHost', 'hasDomainParent', 'sameASN', 'sameNetwork', 'sameCertificate', 'sameRegistrant', 'linksTo', 'redirectsTo', 'contains']):
            raise ValueError("must be one of enum values ('resolvesTo', 'hasNameserver', 'hasMailHost', 'hasDomainParent', 'sameASN', 'sameNetwork', 'sameCertificate', 'sameRegistrant', 'linksTo', 'redirectsTo', 'contains')")
        return value

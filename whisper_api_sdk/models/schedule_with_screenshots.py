...
class ScheduleWithScreenshots(BaseModel):
    """
    A schedule with its captured screenshots
    """ # noqa: E501
    schedule_id: Optional[StrictStr] = Field(default=None, description="Schedule ID")
    url: Optional[StrictStr] = Field(default=None, description="URL being captured")
    screenshots: Optional[List[ScreenshotEntry]] = Field(default=None, description="List of captured screenshots")
    __properties: ClassVar[List[str]] = ["schedule_id", "url", "screenshots"]

...
class MonitoringStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="The target domain or IP being monitored")
    status: Optional[StrictStr] = Field(default=None, description="Current monitoring status")
    metrics: Optional[MonitoringMetrics] = Field(default=None, description="Monitoring metrics and statistics")
    __properties: ClassVar[List[str]] = ["target", "status", "metrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": MonitoringMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj

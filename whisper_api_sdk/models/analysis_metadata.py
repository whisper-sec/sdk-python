...
class AnalysisMetadata(BaseModel):
    ...
    """ # noqa: E501
    techniques_used: StrictStr = Field(description="Comma-separated list of backend similarity types that were used", alias="techniquesUsed")
    base_domain: StrictStr = Field(description="The base domain that was searched", alias="baseDomain")
    search_limit: StrictInt = Field(description="The limit that was applied to the search", alias="searchLimit")
    __properties: ClassVar[List[str]] = ["techniquesUsed", "baseDomain", "searchLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "techniquesUsed": obj.get("techniquesUsed"),
            "baseDomain": obj.get("baseDomain"),
            "searchLimit": obj.get("searchLimit")
        })
        return _obj

...
class PivotResult(BaseModel):
    ...
    """ # noqa: E501
    indicator: Optional[StrictStr] = Field(default=None, description="The starting indicator for pivoting")
    indicator_type: Optional[StrictStr] = Field(default=None, description="Type of the starting indicator", alias="indicatorType")
    depth: Optional[StrictInt] = Field(default=None, description="Depth of pivot operation")
    status: Optional[StrictStr] = Field(default=None, description="Status of the pivot operation")
    error: Optional[StrictBool] = Field(default=None, description="Whether an error occurred")
    message: Optional[StrictStr] = Field(default=None, description="Error message if the pivot failed")
    pivot: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["indicator", "indicatorType", "depth", "status", "error", "message", "pivot"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pivot (nullable) is None
        # and model_fields_set contains the field
        if self.pivot is None and "pivot" in self.model_fields_set:
            _dict['pivot'] = None

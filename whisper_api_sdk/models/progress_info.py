...
class ProgressInfo(BaseModel):
    ...
    """ # noqa: E501
    current: Optional[StrictInt] = Field(default=None, description="Current progress value")
    total: Optional[StrictInt] = Field(default=None, description="Total expected progress value")
    message: Optional[StrictStr] = Field(default=None, description="Progress message")
    __properties: ClassVar[List[str]] = ["current", "total", "message"]

...
class ScreenshotEntry(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL to download the screenshot image")
    captured_at: Optional[datetime] = Field(default=None, description="When the screenshot was captured")
    format: Optional[StrictStr] = Field(default=None, description="Image format")
    dimensions: Optional[StrictStr] = Field(default=None, description="Image dimensions in pixels")
    file_size: Optional[StrictInt] = Field(default=None, description="File size in bytes")
    __properties: ClassVar[List[str]] = ["url", "captured_at", "format", "dimensions", "file_size"]

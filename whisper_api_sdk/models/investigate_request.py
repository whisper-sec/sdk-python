...
class InvestigateRequest(BaseModel):
    ...
    context: Optional[InvestigateContext] = Field(default=None, description="Optional context object to guide the investigation. Provides additional information like hypothesis, related indicators, and time range.")

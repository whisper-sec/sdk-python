...
class QueryInfo(BaseModel):
    ...
    indicator_type: Optional[StrictStr] = None
    history_type: Optional[StrictStr] = None
    timestamp: Optional[StrictStr] = None
    response_time_ms: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["indicator", "indicator_type", "history_type", "timestamp", "response_time_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "indicator_type": obj.get("indicator_type"),

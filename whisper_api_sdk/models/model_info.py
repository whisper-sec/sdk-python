...
class ModelInfo(BaseModel):
    ...
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="Model version")
    last_updated: Optional[StrictStr] = Field(default=None, description="Last updated timestamp", alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["version", "lastUpdated"]

...
class BenchmarkResponse(BaseModel):
    ...
    industry: Optional[IndustryInfo] = Field(default=None, description="Industry identification")
    metrics: Optional[BenchmarkMetrics] = Field(default=None, description="Benchmark metrics")
    percentiles: Optional[PercentileInfo] = Field(default=None, description="Percentile rankings")
    threat_profile: Optional[ThreatProfile] = Field(default=None, description="Industry threat profile", alias="threatProfile")
    trends: Optional[TrendData] = Field(default=None, description="Trend data over time")
    benchmark_info: Optional[BenchmarkInfo] = Field(default=None, description="Benchmark metadata", alias="benchmarkInfo")

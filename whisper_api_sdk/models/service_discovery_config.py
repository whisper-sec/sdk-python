...
class ServiceDiscoveryConfig(BaseModel):
    ...
    """ # noqa: E501
    version_detection: Optional[StrictBool] = Field(default=True, description="Enable service version detection")
    os_detection: Optional[StrictBool] = Field(default=False, description="Enable OS fingerprinting")
    intensity: Optional[Annotated[int, Field(le=9, strict=True, ge=1)]] = Field(default=5, description="Aggressiveness of service detection (1-9)")
    script_scan: Optional[StrictBool] = Field(default=False, description="Enable script scanning")
    __properties: ClassVar[List[str]] = ["version_detection", "os_detection", "intensity", "script_scan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "version_detection": obj.get("version_detection") if obj.get("version_detection") is not None else True,
            "os_detection": obj.get("os_detection") if obj.get("os_detection") is not None else False,
            "intensity": obj.get("intensity") if obj.get("intensity") is not None else 5,
            "script_scan": obj.get("script_scan") if obj.get("script_scan") is not None else False
        })
        return _obj

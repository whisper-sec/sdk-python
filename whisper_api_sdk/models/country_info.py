...
class CountryInfo(BaseModel):
    ...
    """ # noqa: E501
    iso_code: Optional[StrictStr] = Field(default=None, description="ISO 3166-1 alpha-2 country code", alias="isoCode")
    name: Optional[StrictStr] = Field(default=None, description="Full country name in English")
    confidence: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Confidence score for country detection (0-100)")
    __properties: ClassVar[List[str]] = ["isoCode", "name", "confidence"]

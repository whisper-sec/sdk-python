...
class TrackedIndicator(BaseModel):
    """
    ...
    frequency: Optional[StrictStr] = Field(default=None, description="Check frequency: hourly, daily, weekly")
    fields: Optional[List[StrictStr]] = Field(default=None, description="Fields being tracked")
    created_at: Optional[datetime] = Field(default=None, description="When tracking was started")
    last_check_at: Optional[datetime] = Field(default=None, description="When the last check was performed")
    next_check_at: Optional[datetime] = Field(default=None, description="When the next check is scheduled")
    total_changes: Optional[StrictInt] = Field(default=None, description="Total number of changes detected")
    __properties: ClassVar[List[str]] = ["type", "value", "enabled", "frequency", "fields", "created_at", "last_check_at", "next_check_at", "total_changes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "next_check_at": obj.get("next_check_at"),

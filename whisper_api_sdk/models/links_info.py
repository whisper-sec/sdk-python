...
class LinksInfo(BaseModel):
    ...
    top_sources: Optional[List[StrictStr]] = Field(default=None, description="Top linking sources (for incoming links)")
    top_destinations: Optional[List[StrictStr]] = Field(default=None, description="Top link destinations (for outgoing links)")
    __properties: ClassVar[List[str]] = ["total", "top_sources", "top_destinations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "top_sources": obj.get("top_sources"),
            "top_destinations": obj.get("top_destinations")
        })
        return _obj

...
class AttributionContext(BaseModel):
    ...
    """ # noqa: E501
    observed_ttps: Optional[List[StrictStr]] = Field(default=None, description="Observed MITRE ATT&CK technique IDs. See https://attack.mitre.org for reference.", alias="observedTTPs")
    targeted_sector: Optional[StrictStr] = Field(default=None, description="Targeted industry sector. Common values: financial, healthcare, government, technology, energy, retail, manufacturing", alias="targetedSector")
    target_region: Optional[StrictStr] = Field(default=None, description="Geographic region of targets. Use ISO country codes or region names.", alias="targetRegion")
    timeframe: Optional[StrictStr] = Field(default=None, description="Campaign timeframe for attribution. Format: 'YYYY-MM-DD to YYYY-MM-DD' or descriptive like 'Q1 2024'")
    malware_families: Optional[List[StrictStr]] = Field(default=None, description="Known malware families observed in the campaign. Helps narrow down threat actor candidates.", alias="malwareFamilies")

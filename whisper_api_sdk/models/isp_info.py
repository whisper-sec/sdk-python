...
class IspInfo(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="ISP name")
    organization: Optional[StrictStr] = Field(default=None, description="Organization that owns/operates this IP range")
    asn: Optional[StrictInt] = Field(default=None, description="Autonomous System Number")
    asn_organization: Optional[StrictStr] = Field(default=None, description="Organization name associated with the ASN", alias="asnOrganization")
    __properties: ClassVar[List[str]] = ["name", "organization", "asn", "asnOrganization"]

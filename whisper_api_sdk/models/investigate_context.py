...
class InvestigateContext(BaseModel):
    ...
    """ # noqa: E501
    hypothesis: Optional[StrictStr] = Field(default=None, description="Initial hypothesis or suspicion to focus the investigation. The AI will attempt to prove or disprove this theory.")
    related_indicators: Optional[List[StrictStr]] = Field(default=None, description="Related indicators (IPs, domains, hashes) to include in the investigation scope. Helps identify connections between indicators.", alias="relatedIndicators")
    time_range: Optional[StrictStr] = Field(default=None, description="Time range for historical analysis. Format: number + unit (d=days, w=weeks, m=months). Examples: 7d, 2w, 3m, 90d", alias="timeRange")
    industry: Optional[StrictStr] = Field(default=None, description="Industry sector for contextualized threat analysis. Helps identify industry-specific threats and attack patterns.")
    region: Optional[StrictStr] = Field(default=None, description="Geographic region for localized threat intelligence. Helps identify region-specific threats.")
    __properties: ClassVar[List[str]] = ["hypothesis", "relatedIndicators", "timeRange", "industry", "region"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relatedIndicators": obj.get("relatedIndicators"),

...
class CorrelateRequest(BaseModel):
    ...
    """ # noqa: E501
    indicators: Annotated[List[StrictStr], Field(min_length=0, max_length=100)] = Field(description="List of indicators (IPs, domains, hashes) to correlate across global threat intelligence. Maximum 100 indicators per request.")
    options: Optional[CorrelateOptions] = Field(default=None, description="Optional configuration object for correlation analysis. NOT a string - must be an object with fields like timeWindow, minConfidence, etc.")
    __properties: ClassVar[List[str]] = ["indicators", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": CorrelateOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj

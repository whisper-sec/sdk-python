...
class MonitorResultListResponse(BaseModel):
    """
    Response containing a list of check execution results
    """ # noqa: E501
    check_id: Optional[StrictStr] = Field(default=None, description="ID of the check these results belong to")
    count: Optional[StrictInt] = Field(default=None, description="Total number of results returned")
    results: Optional[List[MonitorResultResponse]] = Field(default=None, description="List of check execution results")
    __properties: ClassVar[List[str]] = ["check_id", "count", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "results": [MonitorResultResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj

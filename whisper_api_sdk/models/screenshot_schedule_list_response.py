...
class ScreenshotScheduleListResponse(BaseModel):
    """
    Response containing a list of screenshot schedules and quota information
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of schedules in this response")
    max_schedules: Optional[StrictInt] = Field(default=None, description="Maximum number of schedules allowed per API key")
    max_screenshots_per_schedule: Optional[StrictInt] = Field(default=None, description="Maximum number of screenshots retained per schedule")
    schedules: Optional[List[ScreenshotSchedule]] = Field(default=None, description="List of screenshot schedules")
    __properties: ClassVar[List[str]] = ["count", "max_schedules", "max_screenshots_per_schedule", "schedules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "max_schedules": obj.get("max_schedules"),
            "max_screenshots_per_schedule": obj.get("max_screenshots_per_schedule"),
            "schedules": [ScreenshotSchedule.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None
        })
        return _obj

...
class ScreenshotSchedule(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this schedule")
    url: Optional[StrictStr] = Field(default=None, description="The URL to capture screenshots of")
    username: Optional[StrictStr] = Field(default=None, description="Username/API key owner of this schedule")
    cron: Optional[StrictStr] = Field(default=None, description="Cron expression for scheduling (mutually exclusive with frequency)")
    frequency: Optional[StrictStr] = Field(default=None, description="Frequency preset (mutually exclusive with cron). Use one of the preset values for simplified scheduling.")
    timezone: Optional[StrictStr] = Field(default=None, description="Timezone for the schedule")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether this schedule is currently active")
    options: Optional[ScreenshotOptions] = Field(default=None, description="Screenshot options (width, height, format, etc.)")
    created_at: Optional[datetime] = Field(default=None, description="When this schedule was created")
    updated_at: Optional[datetime] = Field(default=None, description="When this schedule was last updated")
    last_capture_at: Optional[datetime] = Field(default=None, description="When the last screenshot was captured")
    next_capture_at: Optional[datetime] = Field(default=None, description="When the next screenshot is scheduled")
    capture_count: Optional[StrictInt] = Field(default=None, description="Total number of screenshots captured by this schedule")
    __properties: ClassVar[List[str]] = ["id", "url", "username", "cron", "frequency", "timezone", "enabled", "options", "created_at", "updated_at", "last_capture_at", "next_capture_at", "capture_count"]
    ...
    def frequency_validate_enum(cls, value):
        ...
        if value not in set(['hourly', 'every_6_hours', 'every_12_hours', 'twice_daily', 'daily', 'weekly', 'monthly']):
            raise ValueError("must be one of enum values ('hourly', 'every_6_hours', 'every_12_hours', 'twice_daily', 'daily', 'weekly', 'monthly')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": ScreenshotOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "last_capture_at": obj.get("last_capture_at"),
            "next_capture_at": obj.get("next_capture_at"),
            "capture_count": obj.get("capture_count")
        })
        return _obj

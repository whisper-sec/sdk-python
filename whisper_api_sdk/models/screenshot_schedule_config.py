...
class ScreenshotScheduleConfig(BaseModel):
    ...
    """ # noqa: E501
    cron: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Cron expression for scheduling (advanced). Use frequency for simpler configuration.")
    frequency: Optional[StrictStr] = Field(default=None, description="Frequency of captures. Use one of the preset values or provide a cron expression for custom schedules.")

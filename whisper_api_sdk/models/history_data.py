...
class HistoryData(BaseModel):
    ...
    oldest_date: Optional[StrictStr] = None
    newest_date: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["records", "total_records", "oldest_date", "newest_date", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oldest_date": obj.get("oldest_date"),
            "newest_date": obj.get("newest_date"),

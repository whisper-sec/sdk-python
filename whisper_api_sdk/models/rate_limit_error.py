...
class RateLimitError(BaseModel):
    ...
    message: StrictStr = Field(description="Human-readable error message with rate limit category")
    retry_after: StrictInt = Field(description="Number of seconds to wait before retrying", alias="retryAfter")
    __properties: ClassVar[List[str]] = ["error", "message", "retryAfter"]

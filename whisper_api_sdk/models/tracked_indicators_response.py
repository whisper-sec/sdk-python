...
class TrackedIndicatorsResponse(BaseModel):
    """
    Response containing a list of indicators being tracked for changes
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total number of tracked indicators")
    max_tracked: Optional[StrictInt] = Field(default=None, description="Maximum number of indicators that can be tracked per API key")
    indicators: Optional[List[TrackedIndicator]] = Field(default=None, description="List of tracked indicators")
    __properties: ClassVar[List[str]] = ["count", "max_tracked", "indicators"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "max_tracked": obj.get("max_tracked"),
            "indicators": [TrackedIndicator.from_dict(_item) for _item in obj["indicators"]] if obj.get("indicators") is not None else None
        })
        return _obj

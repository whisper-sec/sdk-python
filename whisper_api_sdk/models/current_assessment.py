...
class CurrentAssessment(BaseModel):
    ...
    Current risk state
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence in assessment (0-1)")
    risk_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current risk score (0-100)", alias="riskScore")
    risk_level: Optional[StrictStr] = Field(default=None, description="Risk level category", alias="riskLevel")
    assessed_at: Optional[StrictStr] = Field(default=None, description="Assessment timestamp", alias="assessedAt")
    __properties: ClassVar[List[str]] = ["confidence", "riskScore", "riskLevel", "assessedAt"]

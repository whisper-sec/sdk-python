...
class MonitoringMetrics(BaseModel):
    ...
    """ # noqa: E501
    uptime_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Uptime percentage over the last 30 days", alias="uptimePercentage")
    avg_response_time: Optional[StrictInt] = Field(default=None, description="Average response time in milliseconds", alias="avgResponseTime")
    ssl_expires_in_days: Optional[StrictInt] = Field(default=None, description="Days until SSL certificate expires", alias="sslExpiresInDays")
    dns_change_count: Optional[StrictInt] = Field(default=None, description="Number of DNS change events detected", alias="dnsChangeCount")
    whois_change_count: Optional[StrictInt] = Field(default=None, description="Number of WHOIS change events detected", alias="whoisChangeCount")
    last_check_at: Optional[StrictStr] = Field(default=None, description="Timestamp of last successful check", alias="lastCheckAt")
    current_status: Optional[StrictStr] = Field(default=None, description="Current check status", alias="currentStatus")
    __properties: ClassVar[List[str]] = ["uptimePercentage", "avgResponseTime", "sslExpiresInDays", "dnsChangeCount", "whoisChangeCount", "lastCheckAt", "currentStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uptimePercentage": obj.get("uptimePercentage"),
            "avgResponseTime": obj.get("avgResponseTime"),
            "sslExpiresInDays": obj.get("sslExpiresInDays"),
            "dnsChangeCount": obj.get("dnsChangeCount"),
            "whoisChangeCount": obj.get("whoisChangeCount"),

...
class GraphResponse(BaseModel):
    ...
    """ # noqa: E501
    nodes: Optional[List[GraphNode]] = Field(default=None, description="List of nodes (vertices) in the graph. Each node represents an infrastructure element.")
    links: Optional[List[GraphLink]] = Field(default=None, description="List of links (edges) connecting nodes. Each link represents a relationship between elements.")
    total_nodes: Optional[StrictInt] = Field(default=None, description="Total count of nodes before any limit was applied", alias="totalNodes")
    total_links: Optional[StrictInt] = Field(default=None, description="Total count of links before any limit was applied", alias="totalLinks")
    __properties: ClassVar[List[str]] = ["nodes", "links", "totalNodes", "totalLinks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": [GraphLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
            "totalNodes": obj.get("totalNodes"),
            "totalLinks": obj.get("totalLinks")
        })
        return _obj

...
class JobSummary(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of job")
    status: Optional[StrictStr] = Field(default=None, description="Current job status")
    created_at: Optional[StrictStr] = Field(default=None, description="Job creation timestamp", alias="createdAt")
    completed_at: Optional[StrictStr] = Field(default=None, description="Job completion timestamp (if completed)", alias="completedAt")
    progress: Optional[ProgressInfo] = Field(default=None, description="Job progress information")
    error: Optional[ErrorInfo] = Field(default=None, description="Error information (if failed)")
    __properties: ClassVar[List[str]] = ["jobId", "type", "status", "createdAt", "completedAt", "progress", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": ProgressInfo.from_dict(obj["progress"]) if obj.get("progress") is not None else None,

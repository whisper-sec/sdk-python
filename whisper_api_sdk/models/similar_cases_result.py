...
class SimilarCasesResult(BaseModel):
    ...
    """ # noqa: E501
    indicators: Optional[List[StrictStr]] = Field(default=None, description="List of indicators that were analyzed")
    status: Optional[StrictStr] = Field(default=None, description="Status of the similar cases search")
    error: Optional[StrictBool] = Field(default=None, description="Whether an error occurred")
    message: Optional[StrictStr] = Field(default=None, description="Error message if the search failed")
    similar_cases: Optional[Any] = Field(default=None, alias="similarCases")
    __properties: ClassVar[List[str]] = ["indicators", "status", "error", "message", "similarCases"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if similar_cases (nullable) is None
        # and model_fields_set contains the field
        if self.similar_cases is None and "similar_cases" in self.model_fields_set:
            _dict['similarCases'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "similarCases": obj.get("similarCases")
        })
        return _obj

...
class CypherQueryResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[Dict[str, Any]]] = Field(default=None, description="Query results as a list of records. Each record is a map of column name to value.")
    ...
    columns: Optional[List[StrictStr]] = Field(default=None, description="Column names in the result set")
    truncated: Optional[StrictBool] = Field(default=None, description="Whether the result was truncated due to limit")
    error: Optional[StrictStr] = Field(default=None, description="Error message if the query failed")
    __properties: ClassVar[List[str]] = ["results", "executionTimeMs", "rowCount", "columns", "truncated", "error"]

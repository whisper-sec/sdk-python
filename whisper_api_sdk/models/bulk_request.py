...
class BulkRequest(BaseModel):
    ...
    def include_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['routing', 'rpki', 'historical', 'whois', 'dns', 'ip_intelligence']):
                raise ValueError("each list item must be one of ('routing', 'rpki', 'historical', 'whois', 'dns', 'ip_intelligence')")
        return value

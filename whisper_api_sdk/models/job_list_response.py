...
class JobListResponse(BaseModel):
    ...
    """ # noqa: E501
    jobs: Optional[List[JobSummary]] = Field(default=None, description="List of job summaries")
    total: Optional[StrictInt] = Field(default=None, description="Total number of jobs matching the filter")
    limit: Optional[StrictInt] = Field(default=None, description="Maximum number of jobs returned")
    offset: Optional[StrictInt] = Field(default=None, description="Number of jobs skipped for pagination")
    status: Optional[StrictStr] = Field(default=None, description="Status filter applied (if any)")
    __properties: ClassVar[List[str]] = ["jobs", "total", "limit", "offset", "status"]

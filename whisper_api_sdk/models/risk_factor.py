...
class RiskFactor(BaseModel):
    ...
    """ # noqa: E501
    factor: Optional[StrictStr] = Field(default=None, description="Factor name")
    weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Factor weight (0-1)")
    contribution: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Contribution to score")
    description: Optional[StrictStr] = Field(default=None, description="Factor description")
    __properties: ClassVar[List[str]] = ["factor", "weight", "contribution", "description"]

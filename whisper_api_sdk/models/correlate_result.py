...
class CorrelateResult(BaseModel):
    ...
    """ # noqa: E501
    indicators: Optional[List[StrictStr]] = Field(default=None, description="List of indicators that were correlated")
    status: Optional[StrictStr] = Field(default=None, description="Status of the correlation analysis")
    error: Optional[StrictBool] = Field(default=None, description="Whether an error occurred")
    message: Optional[StrictStr] = Field(default=None, description="Error message if the correlation failed")
    correlation: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["indicators", "status", "error", "message", "correlation"]

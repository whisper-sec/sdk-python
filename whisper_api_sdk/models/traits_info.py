...
class TraitsInfo(BaseModel):
    ...
    """ # noqa: E501
    user_type: Optional[StrictStr] = Field(default=None, description="Classification of the IP address based on its typical use", alias="userType")
    is_anonymous_proxy: Optional[StrictBool] = Field(default=None, description="Whether this IP is associated with anonymous proxy services", alias="isAnonymousProxy")
    is_tor_exit_node: Optional[StrictBool] = Field(default=None, description="Whether this IP is a known Tor exit node", alias="isTorExitNode")
    is_vpn: Optional[StrictBool] = Field(default=None, description="Whether this IP is associated with a VPN service", alias="isVpn")
    __properties: ClassVar[List[str]] = ["userType", "isAnonymousProxy", "isTorExitNode", "isVpn"]
    ...
    def user_type_validate_enum(cls, value):
        ...
        if value not in set(['residential', 'business', 'hosting', 'isp', 'cellular', 'education', 'government', 'military']):
            raise ValueError("must be one of enum values ('residential', 'business', 'hosting', 'isp', 'cellular', 'education', 'government', 'military')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isAnonymousProxy": obj.get("isAnonymousProxy"),
            "isTorExitNode": obj.get("isTorExitNode"),
            "isVpn": obj.get("isVpn")
        })
        return _obj

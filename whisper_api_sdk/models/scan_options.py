...
class ScanOptions(BaseModel):
    ...
    vulnerability: Optional[VulnerabilityConfig] = None
    dns_enum: Optional[DnsEnumConfig] = None
    __properties: ClassVar[List[str]] = ["port_scan", "service_discovery", "vulnerability", "dns_enum"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of port_scan
        if self.port_scan:
            _dict['port_scan'] = self.port_scan.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of dns_enum
        if self.dns_enum:
            _dict['dns_enum'] = self.dns_enum.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "port_scan": PortScanConfig.from_dict(obj["port_scan"]) if obj.get("port_scan") is not None else None,
            "service_discovery": ServiceDiscoveryConfig.from_dict(obj["service_discovery"]) if obj.get("service_discovery") is not None else None,
            "vulnerability": VulnerabilityConfig.from_dict(obj["vulnerability"]) if obj.get("vulnerability") is not None else None,
            "dns_enum": DnsEnumConfig.from_dict(obj["dns_enum"]) if obj.get("dns_enum") is not None else None
        })
        return _obj

...
class GraphQLRequest(BaseModel):
    ...
    """ # noqa: E501
    query: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The GraphQL query or mutation to execute")
    operation_name: Optional[StrictStr] = Field(default=None, description="Name of the operation to execute (for documents with multiple operations)", alias="operationName")
    variables: Optional[Dict[str, Any]] = Field(default=None, description="Variables to pass to the query as key-value pairs")
    __properties: ClassVar[List[str]] = ["query", "operationName", "variables"]

...
class GenericSuccessResponse(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="Human-readable message describing the operation result")
    id: Optional[StrictStr] = Field(default=None, description="ID of the related resource (if applicable)")
    deleted: Optional[StrictBool] = Field(default=None, description="Whether the operation was successful (for delete operations)")
    cleared: Optional[StrictBool] = Field(default=None, description="Whether the operation was successful (for clear operations)")
    schedule_id: Optional[StrictStr] = Field(default=None, description="Schedule ID (for schedule-related operations)")
    __properties: ClassVar[List[str]] = ["status", "message", "id", "deleted", "cleared", "schedule_id"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['triggered', 'deleted', 'cleared', 'success']):
            raise ValueError("must be one of enum values ('triggered', 'deleted', 'cleared', 'success')")
        return value

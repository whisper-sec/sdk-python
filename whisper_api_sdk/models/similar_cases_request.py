...
class SimilarCasesRequest(BaseModel):
    ...
    """ # noqa: E501
    indicators: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="List of indicators (IPs, domains, hashes, URLs) associated with the current case. This is the primary matching criteria.")
    behavior_description: Optional[StrictStr] = Field(default=None, description="Free-text description of observed malicious behavior or incident details. Improves matching accuracy by considering behavioral patterns.", alias="behaviorDescription")
    observed_ttps: Optional[List[StrictStr]] = Field(default=None, description="Observed MITRE ATT&CK technique IDs. Helps find cases with similar attack techniques. See https://attack.mitre.org for reference.", alias="observedTTPs")
    min_similarity: Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0.5, description="Minimum similarity score threshold (0.0 to 1.0). Higher values return fewer but more precise matches. Default: 0.5", alias="minSimilarity")
    limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=10, description="Maximum number of similar cases to return. Higher limits may increase processing time.")
    __properties: ClassVar[List[str]] = ["indicators", "behaviorDescription", "observedTTPs", "minSimilarity", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "behaviorDescription": obj.get("behaviorDescription"),
            "observedTTPs": obj.get("observedTTPs"),
            "minSimilarity": obj.get("minSimilarity") if obj.get("minSimilarity") is not None else 0.5,

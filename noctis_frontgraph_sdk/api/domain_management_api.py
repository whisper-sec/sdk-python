...
class DomainManagementApi:
    ...
    def find_subdomains(
        self,
        base_domain: Annotated[StrictStr, Field(description="Base domain name (e.g., example.com)")],
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None,
        level: Annotated[Optional[StrictStr], Field(description="Level of subdomains to find relative to the base domain (ALL, IMMEDIATE=one level deeper, MAX_DEPTH=deepest found relative to base).")] = None,
        ...
        :param base_domain: Base domain name (e.g., example.com) (required)
        ...
        _param = self._find_subdomains_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DomainerStringListResponse",
            '400': "str",
        }
    ...
    @validate_call
    def find_subdomains_with_http_info(
        self,
        base_domain: Annotated[StrictStr, Field(description="Base domain name (e.g., example.com)")],
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None,
        level: Annotated[Optional[StrictStr], Field(description="Level of subdomains to find relative to the base domain (ALL, IMMEDIATE=one level deeper, MAX_DEPTH=deepest found relative to base).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DomainerStringListResponse]:
        """Find subdomains
    ...
    @validate_call
    def find_subdomains_without_preload_content(
        self,
        base_domain: Annotated[StrictStr, Field(description="Base domain name (e.g., example.com)")],
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None,
        level: Annotated[Optional[StrictStr], Field(description="Level of subdomains to find relative to the base domain (ALL, IMMEDIATE=one level deeper, MAX_DEPTH=deepest found relative to base).")] = None,
    ...
    def _find_subdomains_serialize(
        self,
        base_domain,
        limit,
        level,
        ...
        if base_domain is not None:
            _path_params['baseDomain'] = base_domain
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/domainer/api/domains/subdomains/{baseDomain}',

...
from noctis_frontgraph_sdk.api_response import ApiResponse, T as ApiResponseT
import noctis_frontgraph_sdk.models
from noctis_frontgraph_sdk import rest
from noctis_frontgraph_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(noctis_frontgraph_sdk.models, klass)

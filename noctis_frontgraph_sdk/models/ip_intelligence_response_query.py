...
class IpIntelligenceResponseQuery(BaseModel):
    """
    Query metadata
    """ # noqa: E501
    ip: Optional[StrictStr] = Field(default=None, description="Queried IP address")
    ...
    __properties: ClassVar[List[str]] = ["ip", "timestamp", "response_time_ms"]

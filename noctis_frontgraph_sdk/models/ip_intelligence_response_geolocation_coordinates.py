...
class IpIntelligenceResponseGeolocationCoordinates(BaseModel):
    """
    ...
    accuracy_radius: Optional[StrictInt] = Field(default=None, description="Accuracy radius in kilometers")
    time_zone: Optional[StrictStr] = Field(default=None, description="IANA time zone")
    __properties: ClassVar[List[str]] = ["latitude", "longitude", "accuracy_radius", "time_zone"]

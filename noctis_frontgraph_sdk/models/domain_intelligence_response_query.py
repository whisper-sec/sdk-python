...
class DomainIntelligenceResponseQuery(BaseModel):
    """
    DomainIntelligenceResponseQuery
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Queried domain")
    timestamp: Optional[datetime] = Field(default=None, description="Query timestamp")
    response_time_ms: Optional[StrictInt] = Field(default=None, description="Response time in milliseconds")
    __properties: ClassVar[List[str]] = ["domain", "timestamp", "response_time_ms"]

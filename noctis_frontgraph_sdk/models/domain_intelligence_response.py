...
class DomainIntelligenceResponse(BaseModel):
    ...
    """ # noqa: E501
    query: Optional[DomainIntelligenceResponseQuery] = None
    summary: Optional[DomainIntelligenceResponseSummary] = None
    registration: Optional[Dict[str, Any]] = Field(default=None, description="WHOIS registration details")
    dns: Optional[Dict[str, Any]] = Field(default=None, description="DNS records (A, AAAA, MX, NS, TXT, etc.)")
    relationships: Optional[Dict[str, Any]] = Field(default=None, description="Related domains and infrastructure")
    trademark: Optional[Dict[str, Any]] = Field(default=None, description="Trademark information")
    ip_intelligence: Optional[Dict[str, Any]] = Field(default=None, description="Intelligence for resolved IP addresses")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Response metadata and data sources")
    __properties: ClassVar[List[str]] = ["query", "summary", "registration", "dns", "relationships", "trademark", "ip_intelligence", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": DomainIntelligenceResponseQuery.from_dict(obj["query"]) if obj.get("query") is not None else None,
            "summary": DomainIntelligenceResponseSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,

...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    error: StrictStr = Field(description="Error code for programmatic handling")
    ...
    path: Optional[StrictStr] = Field(default=None, description="Request path that caused the error")
    __properties: ClassVar[List[str]] = ["error", "message", "timestamp", "path"]

...
class IpIntelligenceResponseGeolocation(BaseModel):
    """
    Geolocation data with confidence scores
    """ # noqa: E501
    country: Optional[IpIntelligenceResponseGeolocationCountry] = None
    coordinates: Optional[IpIntelligenceResponseGeolocationCoordinates] = None
    __properties: ClassVar[List[str]] = ["country", "coordinates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country": IpIntelligenceResponseGeolocationCountry.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "coordinates": IpIntelligenceResponseGeolocationCoordinates.from_dict(obj["coordinates"]) if obj.get("coordinates") is not None else None
        })
        return _obj
